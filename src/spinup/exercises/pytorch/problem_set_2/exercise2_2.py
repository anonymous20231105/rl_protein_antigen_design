from src.spinup.algos.pytorch.ddpg.core import mlp, MLPActorCritic
from src.spinup.utils.run_utils import ExperimentGrid
from src.spinup import ddpg_pytorch as ddpg
import numpy as np
import torch
...
if __name__ == '__main__':
    ...
    def ddpg_with_actor_critic(bugged, **kwargs):
        from src.spinup.exercises.pytorch.problem_set_2.exercise2_2 import BuggedMLPActorCritic
